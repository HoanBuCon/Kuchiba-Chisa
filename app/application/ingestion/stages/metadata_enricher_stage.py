    ...
    async def execute(self, job_id: uuid.UUID, input_data: MetadataEnricherInput) -> PipelineResult[List[ProcessingChunk]]:
        ...
        for chunk in input_data.chunks:
            ...
            chunk.payload = LorePayload(
                ...
                access_scope=chunk.access.scope,
                access_subject_id=chunk.access.subject_id,
                access_tenant_id=chunk.access.tenant_id,
                access_channel_id=chunk.access.channel_id,
                chunk_index=chunk.chunk_index,
                chunk_start_offset=chunk.metadata.get("chunk_start_offset"),
                chunk_end_offset=chunk.metadata.get("chunk_end_offset"),
